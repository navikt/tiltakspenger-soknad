...
export const LeggTilBarnModal = React.forwardRef<
    LeggTilBarnModalImperativeHandle,
    LeggTilBarnModalProps
>(function LeggTilBarnModal({ fieldArray }: LeggTilBarnModalProps, ref) {
    const { trigger, getValues, control, setValue, clearErrors } =
        useFormContext<Søknad>();
    ...
    function barnUtenforEØSValidator(verdi: boolean) {
        return påkrevdJaNeiSpørsmålValidator(
            verdi,
            'Du må svare på om barnet bor utenfor EØS'
        );
    }
            ...
            >
                <Modal.Content>
                    ...
                    <JaNeiSpørsmål
                        ...
                        hjelpetekst={{
                            ...
                            tekst: (
                                <>
                                    <span>
                                        Hvis barnet ditt oppholder seg utenfor
                                        EØS i tiltaksperioden kan det ha
                                    ...
                                    >
                                        <Link
                                            ...
                                            target="_blank"
                                        >
                                            Du kan lese mer om hvile land som er
                                            med i EØS her.
                    ...
                    <Button
                        onClick={async (e) => {
                            e.preventDefault();
                            const harIngenValideringsfeil = await trigger(
                                'svar.barnetillegg.kladd'
                            );
                    ...
                    <Alert variant="info">
                        ...
                        <ul>
                            <li>
                                Bekreftelse på at du er forelder til barnet, og
                                fra når (fødselstidspunkt eller
                                adopsjonstidspunkt). Dette kan for eksempel være
                                fødselsattest eller adopsjonsdokumenter.
                            </li>
                        </ul>
                        Dersom du må ettersende vedlegg kan du sende disse pr
                        post.
                    </Alert>
                    <p>
                        Hvis du har vedlegg på papir, kan du skanne det inn og
                        laste det opp. Hvis du ikke har skanner, kan du i stedet
                        ta bilde av dokumentet med mobiltelefonen din.
                    </p>
