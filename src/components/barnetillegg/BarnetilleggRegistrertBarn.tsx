...
function barnUtenforEØSValidator(verdi: boolean) {
    return påkrevdJaNeiSpørsmålValidator(
        verdi,
        'Du må svare på om du søker barnetillegg'
    );
}

export default function BarnetilleggRegistrertBarn({
    barn,
}: BarnetilleggRegistrertBarnProps) {
            ...
            <JaNeiSpørsmål
                ...
                hjelpetekst={{
                    ...
                    tekst: (
                        <>
                            <span>
                                Hvis barnet ditt oppholder seg utenfor EØS i
                                tiltaksperioden kan det ha betydning for din
                            ...
                            >
                                <Link
                                    ...
                                    target="_blank"
                                >
                                    Du kan lese mer om hvile land som er med i
                                    EØS her.
