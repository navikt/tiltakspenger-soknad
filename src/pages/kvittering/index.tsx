...
import {
    dateStrWithHourMinute,
    dateStrWithMonthName,
    ...
    return (
        <div>
            ...
            <h6 className={styles.centerText}>
                Søknaden ble sendt til NAV {formatertInnsendingsTidspunkt}.
            </h6>
            ...
            <Alert variant="success">
                ...
                <p>
                    Vi vil kontakt med deg hvis vi trenger mer informasjon eller
            ...
            <Show if={visManglendeDokVarsel}>
                <Alert variant="warning" style={{ marginTop: '2rem' }}>
                    <span>
                        <span>
                            Vi mangler dokumentasjon fra deg for å kunne
                            behandle søknaden.{' '}
                        </span>
                        <p>Saken din er nå til behandling hos NAV.</p>
                        <p>
                            <Link
                                href="https://www.nav.no/person/ettersende/"
                                target="_blank"
                            >
